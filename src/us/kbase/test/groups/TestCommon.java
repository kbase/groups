...
public class TestCommon {
	...
	public static final String TEST_CONFIG_FILE_PROP_NAME = "KBASE_GROUPS_TEST_CONFIG";
	public static final String TEST_CONFIG_FILE_SECTION = "groupstest";
	...
	public static void stfuLoggers() {
		...
		// these do work
		((ch.qos.logback.classic.Logger) org.slf4j.LoggerFactory
				.getLogger("us.kbase.groups.service.exceptions.ExceptionHandler"))
				.setLevel(ch.qos.logback.classic.Level.OFF);
		((ch.qos.logback.classic.Logger) org.slf4j.LoggerFactory
				.getLogger("us.kbase.groups.service.LoggingFilter"))
				.setLevel(ch.qos.logback.classic.Level.OFF);
		((ch.qos.logback.classic.Logger) org.slf4j.LoggerFactory
				.getLogger("us.kbase.groups.core.Groups"))
				.setLevel(ch.qos.logback.classic.Level.OFF);
	}
