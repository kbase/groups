package us.kbase.groups.service.exceptions;
 ...
 * {@link GroupsException} and subclasses - 400
...
public class ErrorMessage {
	...
	public ErrorMessage(
		...
		if (ex instanceof GroupsException) {
			final GroupsException ae = (GroupsException) ex;
